  ...
  return (
    <div className="flex min-h-screen w-full bg-background pt-15 ">
      <div className="flex min-h-screen w-full  mx-auto">
        {/* Left Panel: Form */}
        <div className="flex w-full items-end flex-col justify-start px-4 py-12 sm:px-6 lg:pr-28 lg:pt-14 lg:flex-none lg:w-1/2">
        ...
        <div className="relative hidden w-0 flex-1 lg:block bg-surface">
          <div className="absolute inset-0 h-full w-full">
            ...
            <div className="relative z-10 flex h-full flex-col justify-start lg:pt-14 px-16 text-foreground">
              <div className="mb-8">
                <h3 className="text-2xl font-bold tracking-tight mb-2">
                  <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand/10 text-brand mb-6 mr-3">
