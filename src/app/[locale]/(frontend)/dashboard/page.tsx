      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <div className="col-span-4 rounded-xl border border-border bg-card text-card-foreground shadow-sm">
          <div className="flex flex-col space-y-1.5 p-6">
            <h3 className="text-lg font-semibold leading-none tracking-tight">Recent Invoices</h3>
              ...
              {recentInvoices.map((invoice) => (
                <div key={invoice.id} className="flex items-center">
                  ...
                  <div className="ml-4 space-y-1">
                    <p className="text-sm font-medium leading-none text-foreground">{invoice.client}</p>
                    <p className="text-sm text-muted-foreground">{invoice.id}</p>
                  </div>
                  <div className="ml-auto font-medium text-foreground">{invoice.amount}</div>
                  <div className={`ml-4 text-xs font-medium px-2 py-1 rounded-full ${
              ...
              {[1, 2, 3].map((_, i) => (
                <div key={i} className="flex items-start gap-4">
                  <div className="relative mt-1">
                    ...
                    {i !== 2 && <div className="absolute left-1 top-3 h-full w-px bg-border" />}
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm font-medium text-foreground">Invoice #INV00{5-i} created</p>
