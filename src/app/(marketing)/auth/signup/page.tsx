...
export default function SignUpPage() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-background">
      {/* Left Panel: Form */}
      <div className="flex w-full flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:w-1/2 xl:w-[45%]">
          ...
          <div className="relative z-10 flex h-full flex-col justify-center px-16 text-foreground">
            ...
            <div className="mt-12 p-6 bg-background/60 backdrop-blur-sm rounded-2xl border border-border shadow-sm">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 italic">
                &quot;Finally an invoicing tool that actually understands German
                tax laws. Setup took 2 minutes.&quot;
              </p>
            </div>
          </div>
        </div>
